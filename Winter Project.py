...
def youtube():        
    ...
    plt.axis('equal')
    plt.title('youtube Sentiment Pie Chart')
    plt.show()
...
def rotten_tomatoes():
    ...
    # Meta_rating= int(x['data']['metascore'])
    # IMDB_rating= mov.data['rating']*10
    ...
    explode = (0.1, 0.1)
    plt.pie(sizes, explode=explode, colors=cols, startangle=90, shadow=True,autopct = '%1.1f%%')
    plt.axis('equal')
    plt.title('rotten tomatoes user sentiments')
    plt.show()
    ...
    plt.pie(sizes, explode=explode, colors=cols, startangle=90, shadow=True,autopct = '%1.1f%%')
    plt.axis('equal')
    plt.title('rotten tomatoes professionals sentiments')
    plt.show()
...
if __name__ == "__main__":
    ...
    tweets = api.get_tweets(query = 'venom', count = 200000000)
    ...
    feedback = ['Positive Review','Negative Review']
    plt.pie(slices, labels = feedback, colors = cols, startangle = 90, shadow = True, explode = (0.1, 0.1), autopct = '%1.1f%%')
    plt.title('twitter Sentiment Pie Chart')
    plt.show()
    ...
    final_percentages=[(final_result_percentage[0]+rotten_tomatoes[0]),(final_result_percentage[1]+rotten_tomatoes[1])]
    ...
    plt.title('Final Sentiment Pie Chart')
    plt.show()
